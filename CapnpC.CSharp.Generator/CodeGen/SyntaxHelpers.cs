...
internal static class SyntaxHelpers
{
    ...
    public static string MakeUpperCamel(string name)
    {
        return $"{char.ToUpperInvariant(name[0])}{name.Substring(1)}";
    }

    public static string MakeLowerCamel(string name)
    {
    ...
    public static TypeSyntax NonNullableType<T>()
    {
        return NonNullableType(typeof(T));
    }
