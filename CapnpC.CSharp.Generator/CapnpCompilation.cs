...
public static class CapnpCompilation
{
    ...
    public static GenerationResult GenerateFromStream(Stream input, GeneratorOptions options)
    {
        if (input == null)
        ...
        try
        {
            ...
            var codeGen = new CodeGenerator(model, options ?? new GeneratorOptions());
    ...
    {
        return GenerateFromStream(input, null);
    }
