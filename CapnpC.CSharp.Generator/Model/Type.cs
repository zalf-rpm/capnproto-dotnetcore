...
internal class Type : AbstractType
{
    // The type of a list element, if this is a list.

    private readonly Dictionary<GenericParameter, Type> _parameterBindings = new();
    ...
    private Field SubstituteGenerics(Field field)
    {
    ...
    private Method SubstituteGenerics(Method method)
    {
