...
public class EdgeCaseHandling : TestBase
{
    ...
    private class MemStreamEndpoint : IEndpoint
    {
        private readonly FramePump _fromEnginePump;
        private readonly BinaryReader _reader;
        private readonly RpcFrameTracer _tracer;

        public MemStreamEndpoint()
        {
            var pipe = new Pipe();
            _tracer = new RpcFrameTracer(Console.Out, false);
        ...
        public WireFrame ReadNextFrame()
        {
            ...
            _tracer.TraceFrame(FrameDirection.Rx, frame);
            return frame;
        }
    }

    private class RpcEngineTester
    {
        private readonly MemStreamEndpoint _fromEngine;
    ...
    private class TestPipelineImpl3 : ITestPipeline
    {
        private readonly TestPipelineImpl2 _impl;
        private readonly ITestPipeline _proxy;
