...
public class RpcSchemaTests
{
    ...
    private void ConstructReconstructTest<TD, TW>(Func<TD> construct, Action<TD> verify)
        ...
        where TW : SerializerState, new()
    {
        ...
        obj.Serialize(root);
        using (var tr = new RpcFrameTracer(Console.Out))
        {
            tr.TraceFrame(FrameDirection.Tx, mb.Frame);
        }
    ...
    public void DcMessageReturnException()
    {
        ConstructReconstructTest<Message, Message.WRITER>(
            ...
            msg =>
            {
                ...
                Assert.AreEqual(Exception.Type.overloaded, msg.Return.Exception.TheType);
            }
        );
    }
    ...
    public void DcMessageResolve()
    {
        ConstructReconstructTest<Message, Message.WRITER>(
            ...
            msg =>
            {
                ...
                Assert.AreEqual(Exception.Type.failed, msg.Resolve.Exception.TheType);
            }
        );
    }
