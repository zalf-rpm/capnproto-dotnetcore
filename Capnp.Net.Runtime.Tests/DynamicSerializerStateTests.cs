...
public class DynamicSerializerStateTests
{
    ...
    public void Struct()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => ds.SetListOfPointers(1));
        Assert.Throws<InvalidOperationException>(() => ds.SetListOfStructs(3, 2, 1));
        Assert.Throws<InvalidOperationException>(() => ds.SetListOfValues(8, 3));
        Assert.Throws<InvalidOperationException>(() => ds.SetStruct(2, 3));
        ds.SetStruct(3, 2);
        ds.Allocate();
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => ds.StructWriteData(191, 2, 1));
    ...
    public void StructWithPrimitives()
    {
        ...
        ds.WriteData(240, false);
        ds.WriteData(241, false, true);
        ds.WriteData(242, true);
    ...
    public void MultiSegmentStruct()
    {
        ...
        ds.SetStruct(1, 2);
        ds.WriteData(0, 815);
        var s0 = "Lorem ipsum dolor sit amet";
        ds.WriteText(0, s0);
    ...
    public void Issue20()
    {
        var rpcRequest = new RpcRequest<ArithmeticOperationRequest>();
        rpcRequest.Method = "AddTwoNumbers";

        var request = new ArithmeticOperationRequest();
        ...
        Console.WriteLine("NumA: " + innerRequest.NumA);
        Console.WriteLine("NumB: " + innerRequest.NumB);
    }
}