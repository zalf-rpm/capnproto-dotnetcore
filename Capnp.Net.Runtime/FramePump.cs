...
/// <summary>
///     The FramePump handles sending and receiving Cap'n Proto messages over a stream. It exposes a Send method for
///     writing frames to the stream, and an
///     event handler for processing received frames. It does not fork any new thread by itself, but instead exposes a
///     synchronous blocking Run method that
...
public class FramePump : IDisposable
{
    ...
    ///     The method does not propagate EndOfStreamException or ObjectDisposedException to the caller, since these conditions
    ///     are considered
    ...
    ///     Received a message with too many or too big segments, probably dues to invalid
    ///     data.
    /// </exception>
    /// <exception cref="IOException">An I/O error occurs.</exception>
    public void Run()
