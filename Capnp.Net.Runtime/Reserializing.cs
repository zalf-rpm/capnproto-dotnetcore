...
public static class Reserializing
{
    ...
    ///     This implementation does not analyze the source object graph and therefore cannot detect multiple references to the
    ///     same object.
    ...
    ///     Target state was already set to a different object type than the source
    ///     state.
    /// </exception>
