...
public struct WirePointer
{
    ...
    /// </summary>
    public static implicit operator WirePointer(ulong value)
    {
        return new WirePointer(value);
    }

    /// <summary>
    ///     Extracts the wire data from the pointer.
    /// </summary>
    public static implicit operator ulong(WirePointer pointer)
    {
        return pointer._ptrData;
    }
    ...
    /// </summary>
    public ListKind ListKind => (ListKind)((int)(_ptrData >> 32) & 0x7);
    ...
    /// </summary>
    public int ListElementCount => (int)(_ptrData >> 35);
    ...
    /// </summary>
    public uint TargetSegmentIndex => (uint)(_ptrData >> 32);

    /// <summary>
    ///     Whether the landing pad is two words (field "B") for inter-segment pointers.
    /// </summary>
    public bool IsDoubleFar => (_ptrData & 4) != 0;
    ...
    /// </summary>
    public uint OtherPointerKind => unchecked((uint)_ptrData) >> 2;

    /// <summary>
    ///     Returns the capability index (field "C") if this is a capability pointer.
    /// </summary>
    public uint CapabilityIndex => (uint)(_ptrData >> 32);
