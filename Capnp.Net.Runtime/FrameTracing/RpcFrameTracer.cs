...
public class RpcFrameTracer : IFrameTracer
{
    ...
    private void RenderMessageTarget(MessageTarget.READER target, FrameDirection dir)
    {
        string tag;
    ...
    private void RenderCapDescriptor(CapDescriptor.READER desc, FrameDirection dir)
    {
        string tag;
