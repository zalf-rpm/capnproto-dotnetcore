...
/// <summary>
///     This SerializerState specialization provides functionality to build arbitrary Cap'n Proto objects without requiring
///     the schema code generator.
/// </summary>
public class DynamicSerializerState : SerializerState
{
    ...
    /// <summary>
    ///     Converts any <see cref="DeserializerState" /> to a DynamicSerializerState instance, which involves deep copying the
    ///     object graph.
    /// </summary>
    ...
    ///     </list>
    /// </exception>
    public new void Link(int slot, SerializerState target, bool allowCopy = true)
    {
        base.Link(slot, target, allowCopy);
    }
    ...
    {
        base.LinkToCapability(slot, capabilityIndex);
    }
    ...
    public new void SetStruct(ushort dataCount, ushort ptrCount)
    {
        base.SetStruct(dataCount, ptrCount);
    }
    ...
    /// <exception cref="InvalidOperationException">The object type was already set to something different</exception>
    public new void SetCapability(uint? capabilityIndex)
    {
        base.SetCapability(capabilityIndex);
    }
    ...
    /// </exception>
    public new void SetListOfValues(byte bitsPerElement, int totalCount)
    {
        base.SetListOfValues(bitsPerElement, totalCount);
    }
    ...
    public new void SetListOfPointers(int totalCount)
    {
        base.SetListOfPointers(totalCount);
    }
    ...
    ///     2^29-1
    /// </exception>
    public new void SetListOfStructs(int totalCount, ushort dataCount, ushort ptrCount)
    {
        base.SetListOfStructs(totalCount, dataCount, ptrCount);
    }
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>An instance implementing <see cref="ICapnpSerializable" /></description>
    ///         </item>
    ///         <item><description>null</description>, <see cref="String" /></item>
    ///         <item>
    ///             <description>
    ///                 <c>IReadOnlyList&lt;byte&gt;</c>, <c>IReadOnlyList&lt;sbyte&gt;</c>,
    ///                 <c>IReadOnlyList&lt;ushort&gt;</c>, <c>IReadOnlyList&lt;short&gt;</c>
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 <c>IReadOnlyList&lt;int&gt;</c>, <c>IReadOnlyList&lt;uint&gt;</c>,
    ///                 <c>IReadOnlyList&lt;long&gt;</c>, <c>IReadOnlyList&lt;ulong&gt;</c>
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 <c>IReadOnlyList&lt;float&gt;</c>, <c>IReadOnlyList&lt;double&gt;</c>,
    ///                 <c>IReadOnlyList&lt;bool&gt;</c>, <c>IReadOnlyList&lt;string&gt;</c>
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description>Another <see cref="DeserializerState" /> or <see cref="SerializerState" /></description>
    ///         </item>
    ///         <item>
    ///             <description>Low-level capability object (<see cref="Rpc.ConsumedCapability" />)</description>
    ///         </item>
    ///         <item>
    ///             <description>Proxy object (<see cref="Rpc.Proxy" />)</description>
    ///         </item>
    ///         <item>
    ///             <description>Skeleton object (<see cref="Rpc.Skeleton" />)</description>
    ///         </item>
    ///         <item>
    ///             <description>Capability interface implementation</description>
    ///         </item>
    ///         <item>
    ///             <description><c>IReadOnlyList&lt;object&gt;</c>, whereby each list item is one of the things listed here.</description>
    ///         </item>
    ///     </list>
    /// </param>
