    ...
    where T : unmanaged
{
    ...
    public ReadOnlySpan<T> Span =>
        MemoryMarshal.Cast<ulong, T>(State.CurrentSegment.Slice(State.Offset)).Slice(0, Count);
    ...
    /// </summary>
    public override IReadOnlyList<bool> CastBool()
    {
        throw new NotSupportedException("Cannot cast to list of bits");
    }
    ...
    public override IReadOnlyList<byte> CastByte()
    {
    ...
    /// <returns>The desired representation</returns>
    /// <exception cref="NotSupportedException">Element size is different from 1 byte.</exception>
    public override IReadOnlyList<sbyte> CastSByte()
    {
        return PrimitiveCast<sbyte>();
    }
    ...
    public override IReadOnlyList<ushort> CastUShort()
    {
    ...
    /// <returns>The desired representation</returns>
    /// <exception cref="NotSupportedException">Element size is different from 2 bytes.</exception>
    public override IReadOnlyList<short> CastShort()
    {
        return PrimitiveCast<short>();
    }
    ...
    public override IReadOnlyList<uint> CastUInt()
    {
    ...
    /// <returns>The desired representation</returns>
    /// <exception cref="NotSupportedException">Element size is different from 4 bytes.</exception>
    public override IReadOnlyList<int> CastInt()
    {
        return PrimitiveCast<int>();
    }
    ...
    public override IReadOnlyList<ulong> CastULong()
    {
        return PrimitiveCast<ulong>();
    }
    ...
    /// <returns>The desired representation</returns>
    /// <exception cref="NotSupportedException">Element size is different from 8 bytes.</exception>
    public override IReadOnlyList<long> CastLong()
    {
        return PrimitiveCast<long>();
    }
    ...
    /// <returns>The desired representation</returns>
    /// <exception cref="NotSupportedException">Element size is different from 4 bytes.</exception>
    public override IReadOnlyList<float> CastFloat()
    {
        return PrimitiveCast<float>();
    }
    ...
    /// <returns>The desired representation</returns>
    /// <exception cref="NotSupportedException">Element size is different from 8 bytes.</exception>
    public override IReadOnlyList<double> CastDouble()
    {
        return PrimitiveCast<double>();
    }
