...
/// <summary>
///     ListDeserializer specialization for List(T) when T is unknown (generic), List(Data), List(Text), and
///     List(List(...)).
/// </summary>
public class ListOfPointersDeserializer : ListDeserializer, IReadOnlyList<DeserializerState>
{
    ...
    /// </summary>
    /// <returns>
    ///     The desired representation. Since it is evaluated lazily, type conflicts will not happen before accessing the
    ///     resulting list's elements.
    /// </returns>
