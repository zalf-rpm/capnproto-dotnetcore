...
public static class CapnpSerializable
{
    ...
    private static object? CreateFromAny(DeserializerState state)
    {
        switch (state.Kind)
        {
    ...
    private static Func<DeserializerState, object?> CreateSerializer(Type type)
    {
        ...
        try
        {
            CapabilityReflection.ValidateCapabilityInterface(type);
        }
        catch (Exception ex)
        {
            throw new ArgumentException(
    ...
    private static Func<DeserializerState, object?> GetSerializer(Type type)
    {
    ...
    ///         <item>
    ///             <description>
    ///                 Type implementing <see cref="ICapnpSerializable" />. The type must must have a public
    ///                 parameterless constructor.
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 A capability interface (<seealso cref="Rpc.InvalidCapabilityInterfaceException" /> for further
    ///                 explanation)
    ///             </description>
    ///         </item>
    ///         <item>
    ...
    ///         </item>
    ///         <item>
    ///             <description>IReadOnlyList&lt;bool&gt;, IReadOnlyList&lt;sbyte&gt;, IReadOnlyList&lt;byte&gt;</description>
    ///         </item>
    ///         <item>
    ///             <description>IReadOnlyList&lt;short&gt;, IReadOnlyList&lt;ushort&gt;, IReadOnlyList&lt;int&gt;</description>
    ///         </item>
    ///         <item>
    ///             <description>IReadOnlyList&lt;uint&gt;, IReadOnlyList&lt;long&gt;, IReadOnlyList&lt;ulong&gt;</description>
    ///         </item>
    ///         <item>
    ///             <description>IReadOnlyList&lt;float&gt;, IReadOnlyList&lt;double&gt;</description>
    ///         </item>
    ///         <item>
    ///             <description>IReadOnlyList&lt;T&gt; whereby T is one of the things listed here.</description>
    ///         </item>
    ///     </list>
    /// </typeparam>
    /// <param name="state">deserializer state to construct from</param>
    /// <returns>
    ///     The domain object instance. Nullability note: The returned reference may be null if
    ///     <paramref name="state" /> represents the nil object.
    /// </returns>
    ...
    private interface IConstructibleFromDeserializerState
    {
        object? Create(DeserializerState state);
    }

    private class FromStruct<T> : IConstructibleFromDeserializerState
    ...
    private class FromList<T> : IConstructibleFromDeserializerState
        where T : class
    {
        private readonly Func<DeserializerState, T> _elementSerializer;
    ...
    private class FromCapability<T> : IConstructibleFromDeserializerState
        where T : class
    {
        public object? Create(DeserializerState state)
        {
