...
/// <summary>
///     Provides extensions to the <see cref="IStructDeserializer" /> and <see cref="IStructSerializer" /> interfaces for
...
public static class SerializerExtensions
{
    ...
    /// <summary>
    ///     Performs a "reinterpret cast" of the struct's data section and returns a reference to a single element of the cast
    ///     result.
    /// </summary>
    /// <typeparam name="U">
    ///     The cast target type. Must be a primitive type which qualifies for
    ///     <code><![CDATA[MemoryMarshal.Cast<ulong, U>()]]></code>
    /// </typeparam>
    /// <param name="d">"this" instance</param>
