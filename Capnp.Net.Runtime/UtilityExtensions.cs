...
#else
    public static bool ReplacementTryAdd<K, V>(this Dictionary<K, V> thisDict, K key, V value) where K : struct =>
        thisDict.TryAdd(key, value);
#endif
...
#else
    public static int ReplacementSingleToInt32Bits(this float value)
    {
...
#else
    public static float ReplacementInt32ToSingleBits(this int value)
    {
