...
/// <summary>
///     Base class for a low-level capability at consumer side. It is created by the <see cref="RpcEngine" />. An
///     application does not directly interact with it
///     (which is intentionally impossible, since the invocation method is internal), but instead uses a
///     <see cref="Proxy" />-derived wrapper.
/// </summary>
