...
{
    private readonly CensorCapability _censorCapability;
    private readonly PromisedAnswer _promisedAnswer;
    private object _bob;
    ...
    ///                 either <see cref="OutArgs" /> or <see cref="Exception" />.
    ///             </description>
    ///         </item>
    ///     </list>
    /// </summary>
    ...
    /// </summary>
    public CancellationToken CancelFromAlice { get; }
    ...
    ///         </item>
    ///         <item>
    ///             <description>A <see cref="Proxy" />-derived object</description>
    ///         </item>
    ///         <item>
    ///             <description>A <see cref="Skeleton" />-derived object</description>
    ///         </item>
    ///         <item>
    ///             <description>A <see cref="ConsumedCapability" />-derived object (low level capability)</description>
    ///         </item>
    ///     </list>
    /// </summary>
    /// <remarks>
    ...
    private class PromisedAnswer : IPromisedAnswer
    {
        private readonly CallContext _callContext;
        private readonly CancellationTokenSource _cancelFromAlice = new();
        private readonly TaskCompletionSource<DeserializerState> _futureResult = new();
