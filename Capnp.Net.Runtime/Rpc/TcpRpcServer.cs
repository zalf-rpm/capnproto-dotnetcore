...
public class TcpRpcServer : ISupportsMidlayers, IDisposable
{
    ...
    private readonly RpcEngine _rpcEngine;
    ...
    ///     <paramref name="port" /> is not between System.Net.IPEndPoint.MinPort and
    ...
    private ILogger Logger { get; } = Logging.CreateLogger<TcpRpcServer>();
    ...
    ///     The thread will die after calling <see cref="StopListening" />, upon disposal, but also in case of a socket error
    ///     condition.
    ...
    ///     Thus, we have a hook mechanism for transforming data before it is sent to the TCP connection or after it was
    ///     received
    ///     by the TCP connection, respectively. This mechanism can be used for buffering, various (de-)compression algorithms,
    ///     and more.
    /// </summary>
    ...
    private class OutboundTcpEndpoint : IEndpoint
    {
    ...
    private class Connection : IConnection
    {
        ...
        private readonly List<IFrameTracer> _tracers = new();
        ...
        private ILogger Logger { get; } = Logging.CreateLogger<Connection>();
        ...
        /// <summary>
        ///     Installs a midlayer. A midlayer is a protocal layer that resides somewhere between capnp serialization and the raw
        ///     TCP stream.
        ///     Thus, we have a hook mechanism for transforming data before it is sent to the TCP connection or after it was
        ///     received
        ///     by the TCP connection, respectively. This mechanism may be used for integrating various (de-)compression
        ///     algorithms.
        /// </summary>
