...
internal class PendingAnswer : IDisposable
{
    private readonly StrictlyOrderedAwaitTask<AnswerOrCounterquestion> _answerTask;
    private readonly TaskCompletionSource<AnswerOrCounterquestion> _cancelCompleter;
    ...
    private async void TakeCapTableOwnership()
    {
        try
        {
