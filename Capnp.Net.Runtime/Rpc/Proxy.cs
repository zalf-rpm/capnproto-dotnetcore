...
public class Proxy : IDisposable, IResolvingCapability
{
    ...
    private ConsumedCapability _consumedCap = NullCapability.Instance;

    /// <summary>
    ///     Underlying low-level capability
    /// </summary>
    public ConsumedCapability ConsumedCap =>
        IsDisposed ? throw new ObjectDisposedException(nameof(Proxy)) : _consumedCap;
    ...
    ///     <typeparamref name="T" /> did not qualify as capability
    ///     interface.
    /// </exception>
