...
public class SegmentAllocator : ISegmentAllocator
{
    ...
    private readonly List<Segment> _nonFullSegments = new();
    private readonly List<Segment> _segments = new();

    /// <summary>
    ///     Constructs an instance.
    /// </summary>
    /// <param name="defaultSegmentSize">
    ///     Default size (in words) of a newly allocated segment. If a single allocation requires
    ///     a bigger size, a bigger dedicated segment will be allocated. On the wire, segments will be truncated to their
    ///     actual
    ///     occupancies.
    /// </param>
    ...
    /// <param name="preferredSegmentIndex">
    ...
    ///     a new one will be allocated, or allocation will fail (depending on <paramref name="forcePreferredSegment" />).
    /// </param>
    /// <param name="result">
    ///     The allocated memory slice in case of success (<code>default(SegmentSlice) otherwise)</code>
    /// </param>
    /// <param name="forcePreferredSegment">
